...
ElevatorGoToEncoder::ElevatorGoToEncoder(int position) {
...
void ElevatorGoToEncoder::Initialize() {
...
void ElevatorGoToEncoder::Execute() {

}

// Make this return true when this Command no longer needs to run execute()
bool ElevatorGoToEncoder::IsFinished() { 
  return Robot::m_Elevator.IsElevatorAtTarget();
  
 }

// Called once after isFinished returns true
void ElevatorGoToEncoder::End() {}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void ElevatorGoToEncoder::Interrupted() {}
