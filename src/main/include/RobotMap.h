...
#define CAMERA_TILTANGLE_BALL           110.0     // 130.0  (bag-night)
#define CAMERA_TILTANGLE_CHEVRON        96.0       // 100.0 (bag night value)
...
#define ELEVATOR_MAX_INTEGRAL_ACCUMULATOR   60000.0     // in encoder units x ms
...
#define TILT_ENCODER_PULSE_PER_REVOLUTION   4096
    ...
    #define TILT_PEAKCURRENT_LIMIT          12
...
// Elevator defined positions - in # of encoder pulses
#define TILT_UP_POSITION                0       //0 
#define TILT_MID_POSITION               965     // 615 before adjust
#define TILT_DOWN_POSITION              1200    // 700 before adjust
#define TILT_BALL_POSITION              1300    //1050 before adjust

// Elevator positional tolerance. Elevator reports to driverstation if position if within +/- tolerance of target position
#define TILT_POSITION_TOLERANCE         100

#define TILT_MAX_INTEGRAL_ACCUMULATOR   50000  // Feb 18 2000
...
// claw current limit (A)
#define SNOWBLOWER_CURRENT_LIMIT_IN     5
...
#define FRONT_PISTON_EXTEND_CHANNEL 5
#define FRONT_PISTON_RETRACT_CHANNEL 6
#define REAR_PISTON_EXTEND_CHANNEL 3
#define REAR_PISTON_RETRACT_CHANNEL 4
